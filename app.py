...
def get_intelligent_response(query, res):
    ...
    # ১. যদি কোনো সমস্যার কথা বলে (চুলকানি, দাগ ইত্যাদি)
    if any(word in query for word in ["দাগ", "চুলকানি", "skin", "rash", "problem", "সমস্যা", "লাল", "ব্যাথ"]):
        return (
    ...
    # ২. যদি আগে থেকেই কোনো রেজাল্ট শনাক্ত হয়ে থাকে
    if res and res != "None":
    ...
    return "আমি আপনার ত্বকের সুরক্ষায় সাহায্য করতে এখানে আছি। আপনার কোনো নির্দিষ্ট সমস্যা থাকলে বিস্তারিত বলুন বা একটি ছবি আপলোড করে পরীক্ষা করুন।"
