...
def get_intelligent_response(query, res):
    ...
    # ১. ইউজার যখন সমস্যার কথা বলবে (প্রাথমিক আলাপ)
    if any(word in query for word in ["দাগ", "চুলকানি", "skin", "rash", "problem", "সমস্যা", "লাল"]):
        return """
        আপনার সমস্যার কথা শুনে আমি বুঝতে পারছি আপনি অস্বস্তিতে আছেন। 
        এই দাগ বা সমস্যাটি কি হঠাৎ করে হয়েছে? এটি কি খুব বেশি চুলকায় বা জ্বালাপোড়া করে?
    ...
    # ২. যদি অলরেডি একটি ছবি আপলোড করা থাকে (রেজাল্ট পাওয়ার পর)
    if res and res != "None":
        if any(word in query for word in ["কিভাবে", "কি করবো", "solution", "প্রতিকার", "ভয়"]):
            return f"""
            শনাক্তকৃত সমস্যাটি হলো **{res}**। এটি সাধারণত ভয়ের কিছু নয়, তবে আপনার কি এটিতে ব্যথা অনুভব হয়? 
            সাধারণত এটি দ্রুত ছড়ায় না। তবে আপনি চাইলে পরিষ্কার পানিতে জায়গাটি ধুয়ে রাখতে পারেন এবং চূড়ান্ত সিদ্ধান্তের জন্য একজন চর্মরোগ বিশেষজ্ঞকে দেখাতে পারেন।
            """

    # ৩. সাধারণ হাই/হ্যালো
    return "আমি আপনার ত্বকের সুরক্ষায় সাহায্য করতে এখানে আছি। আপনার কোনো সমস্যা থাকলে বিস্তারিত বলুন বা একটি ছবি আপলোড করে পরীক্ষা করুন।"
