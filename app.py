...
def get_intelligent_response(query, res):
    ...
    # [HIGH PRIORITY] ১. ইউজার যখন নির্দিষ্ট নাম, বেস্ট সাজেশন বা ব্যক্তিগত মতামত জানতে চাইবে
    ...
    # ২. ইউজার যখন শুধু কিসের ডাক্তার বা কোন ক্যাটাগরি জানতে চাইবে (সাধারণ প্রশ্ন)
